...
public class CustomEntryOld implements  Comparable<CustomEntryOld> {

    static Logger logger = LogManager.getLogger(CustomEntryOld.class);
    ...
    public CustomEntryOld(String dn)
    {
    ...
    @Override
    public int compareTo(CustomEntryOld o) {
        try {
    ...
    public CustomEntryOld(com.unboundid.ldap.sdk.Entry entry)
    {
    ...
    public CustomEntryOld(String dn, String rdn, List<Attribute> attributes)
    {
